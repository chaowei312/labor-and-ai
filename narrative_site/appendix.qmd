...
A companion tooling brief (`5200_finalproj/notes/AGENT_EDA_TOOLS.md`) explains why deterministic profiling (`ydata-profiling`) is the source of truth for numbers and why conversational LLMs are not.
...
The eight matplotlib counterparts to the interactive figures on the main page. These are the print-ready, no-interaction reads of the same data. Each is generated by the matching `scripts/narrative/figs/fig_NN_*.py` script and shares the design-system palette via `_common.py`.

![Figure 01 — Indexed sector employment, January 2010 = 100. Source: BLS CES, national, seasonally adjusted.](figs/fig_01_ces_indexed.png){fig-alt="Indexed sector employment by major BLS supersector, January 2010 to March 2026"}

![Figure 02 — Sector momentum, year-over-year percent change. Source: BLS CES.](figs/fig_02_ces_yoy.png){fig-alt="Year-over-year percent change in payroll employment by sector"}

![Figure 03 — Sector share of total nonfarm payrolls. Source: BLS CES.](figs/fig_03_ces_share.png){fig-alt="Stacked share of total nonfarm employment by sector over time"}

![Figure 04 — Distribution of AI Occupational Exposure across U.S. detailed occupations. Source: Felten, Raj & Seamans (SOC 2010).](figs/fig_04_aioe_distribution.png){fig-alt="Histogram of AIOE scores across detailed occupations"}

![Figure 05 — AIOE by SOC major group. Source: Felten et al. crosswalked to 22 SOC 2010 major groups.](figs/fig_05_aioe_by_major_soc.png){fig-alt="AIOE distribution by occupational major group"}

![Figure 06 — Annual mean wages, 2012 → 2023, OEWS national panel.](figs/fig_06_oews_wage_distribution.png){fig-alt="Wage distribution by detailed occupation over OEWS anchor years"}

![Figure 07 — Wage growth 2012 → 2018, occupation by occupation. SOC 2010 era only.](figs/fig_07_oews_wage_growth_2012_2018.png){fig-alt="Per-occupation wage growth distribution between 2012 and 2018"}

![Figure 08 — AI exposure × wages × employment, 2018. Source: BLS OEWS May 2018 + Felten et al. AIOE.](figs/fig_08_aioe_x_oews_2018.png){fig-alt="Scatter of AIOE versus log mean wage with bubble size as employment, 2018"}
